...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference("Datum.count") do
      post data_url, params: { datum: { branch: @datum.branch, fees: @datum.fees, name: @datum.name, roll_no: @datum.roll_no } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { branch: @datum.branch, fees: @datum.fees, name: @datum.name, roll_no: @datum.roll_no } }
